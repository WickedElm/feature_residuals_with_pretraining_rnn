...
class MtlPretrainLstmClf(pl.LightningModule):
    def __init__(
        self, 
        in_dims=24, 
        clf_input_type='',
    ...
    def forward(self, X):
        ...
        # pytorch defaults h0 and c0 to all zeros since we don't pass anything in
        rout, hncn = self.lstm(clf_input)
